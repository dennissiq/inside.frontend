...
CREATE TABLE IF NOT EXISTS `PI_6_INSIDE`.`TB_PROJETO` (
  ...
  INDEX `FK_TB_PROJETO_TB_USUARIO1_IDX` (`ID_USUARIO` ASC),
...
CREATE TABLE IF NOT EXISTS `PI_6_INSIDE`.`TB_DEMANDA` (
  ...
  INDEX `FK_TB_DEMANDA_TB_USUARIO1_IDX` (`ID_USUARIO` ASC),
...
-- PROJETO 
INSERT INTO TB_PROJETO (ID_PROJETO, DESC_PROJETO, ID_USUARIO, ID_CLIENTE, DETALHE, ATIVIDADE,INICIO_PROJ, FIM_PROJ, HORAS) VALUES (1234, 'Reestruturação do ambiente de TI', 1, 1, 'Reestruturar o ambiente físico de TI com a instalação de novo cabeamento e novo parque de máquinas', 'Instalar sistema operacional Windows 10 nas 50 estações', '2019-01-01', '2019-02-01', '160');

-- TABELA DE DEMANDA
INSERT INTO TB_DEMANDA (DESC_DEMANDA, DETALHES, ID_PROJETO, ID_USUARIO, DURACAO) VALUES ('Instalar sistema operacional', 'Instalação do sistema operacional Windows 10 nas 50 estações de trabalho', 1234, 2, '40');
